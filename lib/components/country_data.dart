...
import 'package:covid_tracker/components/slider_switch.dart';
...
class _CountryState extends State<Country> {
  ...
  Future<List<SingleCountry>> getCountryName() async{
    final response = await http.get(Uri.https('disease.sh', '/v3/covid-19/countries'));
    print(response.body);
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  const Text("Welcome"),
                  Container(
                    child: FutureBuilder<List<SingleCountry>>(
                      future: singleCountry,
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          return DropdownButton(
                            hint: const Text("Select a country"), // Add a hint here
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                      NumberFormat.compact().format(snapshot.data!.cases),
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: Alignment.bottomRight,
                                    child: Text(
                                      NumberFormat.compact().format(snapshot.data!.active),
                                      style: const TextStyle(
                                        fontSize: 24,
                                        color: Colors.blue,
                                        fontWeight: FontWeight.bold,
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: Alignment.bottomRight,
                                    child: Text(
                                      NumberFormat.compact().format(snapshot.data!.recovered),
                                      style: const TextStyle(
                                        fontSize: 24,
                                        color: Colors.green,
                                        fontWeight: FontWeight.bold,
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: Alignment.bottomRight,
                                    child: Text(
                                      NumberFormat.compact().format(snapshot.data!.deaths),
                                      style: const TextStyle(
                                        fontSize: 24,
                                        color: Colors.grey,
                                        fontWeight: FontWeight.bold,
  ...
  List<SingleCountry> parseData(String responseBody){
    final parsed = jsonDecode(responseBody).cast<Map<String,dynamic>>();
    return parsed.map<SingleCountry>((json) => SingleCountry.fromJson(json)).toList();
  }
}
